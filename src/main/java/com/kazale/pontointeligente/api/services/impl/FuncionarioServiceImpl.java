...
import com.kazale.pontointeligente.api.entity.Funcionario;
...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public Optional<Funcionario> buscarPorId(Long id) {
		...
		// findOne foi descontinuado das versões acima 2.0.3
		//er substituído pelo método "findById" com uma pequena adaptação findById(id).orElse(null)
		// ou usando getOne
